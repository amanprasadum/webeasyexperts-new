      ...
      <div class="row g-4" data-aos="fade-up">
        ...
        <div class="col-lg-5">
          <a href="blog/hire-php-developers-in-india.php" class="blog-feat d-block">
            ...
            <div class="blog-feat-bg" style="background-image:url('assets/images/hire-php-develper-in-india.png');background-size:cover;background-position:center;"></div>
        ...
        <div class="col-lg-7">
          <div class="row g-3 h-100">
            ...
            <div class="col-sm-6">
              <a href="blog/hire-wordpress-developer-in-india.php" class="blog-sm d-flex">
