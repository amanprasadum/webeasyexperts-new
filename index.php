...
<body>
  ...
  <!-- ══════ CITY SPOTLIGHT — Australia landing page ══════ -->
  <section class="section" style="background:var(--subtle);border-top:1px solid var(--border)">
    <div class="container">
      <div class="row align-items-center g-4">
        <div class="col-lg-7" data-aos="fade-up">
          <div class="section-label"><i class="bi bi-globe-asia-australia"></i> Serving Australia</div>
          <h2 class="section-title" style="max-width:560px">Hire Indian Web Developers<br> for Your <span
              class="accent">Australian Business</span></h2>
          <p class="section-sub" style="max-width:560px;margin:0">
            Affordable, high-quality website design and development for Australian businesses — built by an
            experienced Indian web team.
          </p>
        </div>
        <div class="col-lg-5 text-lg-end" data-aos="fade-up" data-aos-delay="100">
          <a href="hire-indian-website-designers-developers-australia.php" class="btn btn-brand d-inline-flex align-items-center gap-2">
            See Our Australia Page <i class="bi bi-arrow-right"></i></a>
        </div>
      </div>
    </div>
  </section>
          ...
          <div class="row g-3 h-100">
            <div class="col-sm-6">
              <a href="#" class="blog-sm d-flex">
                <div><span class="blog-sm-tag tag-branding">Branding</span></div>
                <div class="blog-sm-title">5 Logo Design Mistakes Indian Businesses Make (And How to Avoid Them)</div>
                <div class="blog-sm-desc">Your logo is your first impression. Here's what to avoid if you want to be
                  taken seriously.</div>
                <div class="blog-sm-meta">
                  <div class="blog-sm-av" style="background:#7C3AED">AM</div>
                  <span>Arjun Mehta</span><span>·</span><span>5 min</span>
                </div>
              </a>
            </div>
            <div class="col-sm-6">
      ...
      <div class="row align-items-center g-4">
        ...
        <div class="col-lg-7" data-aos="fade-left-off">
          <div class="callback-form">
            <input type="text" class="callback-input" placeholder="Your Name" />
            <input type="tel" class="callback-input" placeholder="Phone / WhatsApp" />
            <select class="callback-input fc-select"
            ...
            <button class="callback-btn"><i class="bi bi-telephone-fill me-2"></i>Request Callback</button>
          </div>
