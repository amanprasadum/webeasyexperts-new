      ...
      <div class="row g-5 align-items-start">
        ...
        <div class="col-lg-7" data-aos="fade-right" data-aos-duration="800">
          <div class="wct-form-card">
            ...
            <form id="wct-form" novalidate>
              <div class="row g-0">
                <div class="col-sm-6 pe-sm-2">
                  <div class="wct-field">
                    <label>Full Name <span class="req">*</span></label>
                    <input type="text" class="wct-input" id="f-name" placeholder="John Smith" required />
                  </div>
                </div>
                <div class="col-sm-6 ps-sm-2">
                  <div class="wct-field">
                    <label>Company <span class="opt">(optional)</span></label>
                    <input type="text" class="wct-input" id="f-company" placeholder="Acme Corp" />
                  </div>
                </div>
                <div class="col-sm-6 pe-sm-2">
                  <div class="wct-field">
                    <label>Email <span class="req">*</span></label>
                    <input type="email" class="wct-input" id="f-email" placeholder="john@example.com" required />
                  </div>
                </div>
                <div class="col-sm-6 ps-sm-2">
                  <div class="wct-field">
                    ...
                    <div class="wct-phone-wrap">
                      ...
                      <input type="tel" class="wct-input" id="f-phone" placeholder="91 94321 20437" required />
                    </div>
                  </div>
                </div>
                <div class="col-sm-6 pe-sm-2">
                  <div class="wct-field">
                    ...
                    <div class="wct-sel-wrap">
                      <select class="wct-select wct-input" id="f-service">
                ...
                <div class="col-sm-6 ps-sm-2">
                  <div class="wct-field">
                    ...
                    <div class="wct-sel-wrap">
                      <select class="wct-select wct-input" id="f-budget">
                ...
                <div class="col-12">
                  <div class="wct-field mb-0">
                    ...
                    <textarea class="wct-textarea" id="f-msg"
      ...
      <div class="wct-cta-wrap" data-aos="fade-up" data-aos-duration="800">
        ...
        <div>
          <div class="wct-chip"
            ...
            <span class="dot" style="background:var(--red);"></span> Free Consultentation
          </div>
